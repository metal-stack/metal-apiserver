	...
	tests := []struct {
		...
		},
		{
			...
			tenantServiceMock: func(mock *tmock.Mock) {
				mock.On("Get", tmock.Anything, &mdmv1.TenantGetRequest{
					Id: "john@github",
				}).Return(&mdmv1.TenantResponse{Tenant: &mdmv1.Tenant{Meta: &mdmv1.Meta{Id: "john@github", Annotations: map[string]string{repository.TenantTagEmail: "mail@john"}}}}, nil)
			},
			wantUser: &security.User{
				EMail:   "mail@john",
				Name:    "",
		...
		},
		{
			...
			tenantServiceMock: func(mock *tmock.Mock) {
				mock.On("Get", tmock.Anything, &mdmv1.TenantGetRequest{
					Id: "user@github",
				}).Return(&mdmv1.TenantResponse{Tenant: &mdmv1.Tenant{Meta: &mdmv1.Meta{Id: "user@github", Annotations: map[string]string{repository.TenantTagEmail: "mail@user"}}}}, nil)
			},
			wantUser: &security.User{
				EMail:   "mail@user",
				Name:    "",
		...
		},
		{
			...
			tenantServiceMock: func(mock *tmock.Mock) {
				mock.On("Get", tmock.Anything, &mdmv1.TenantGetRequest{
					Id: "t1",
				}).Return(&mdmv1.TenantResponse{Tenant: &mdmv1.Tenant{Meta: &mdmv1.Meta{Id: "t1", Annotations: map[string]string{repository.TenantTagEmail: "mail@t1"}}}}, nil)
			},
			wantUser: &security.User{
				EMail:   "mail@t1",
				Name:    "",
		...
		},
		{
			...
			tenantServiceMock: func(mock *tmock.Mock) {
				mock.On("Get", tmock.Anything, &mdmv1.TenantGetRequest{
					Id: "a-tenant",
				}).Return(&mdmv1.TenantResponse{Tenant: &mdmv1.Tenant{Meta: &mdmv1.Meta{Id: "a-tenant", Annotations: map[string]string{repository.TenantTagEmail: "mail@tenant-a"}}}}, nil)
			},
			wantUser: &security.User{
				EMail:   "mail@tenant-a",
				Name:    "",
		...
		},
		{
			...
			tenantServiceMock: func(mock *tmock.Mock) {
				mock.On("Get", tmock.Anything, &mdmv1.TenantGetRequest{
					Id: "user@github",
				}).Return(&mdmv1.TenantResponse{Tenant: &mdmv1.Tenant{Meta: &mdmv1.Meta{Id: "user@github", Annotations: map[string]string{repository.TenantTagEmail: "mail@github"}}}}, nil)
			},
			wantUser: &security.User{
				EMail:   "mail@github",
				Name:    "",
