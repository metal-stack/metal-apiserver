...
func Test_auditServiceServer_Get(t *testing.T) {
	...
	tests := []struct {
		name    string
		rq      *apiv2.AuditServiceGetRequest
		entries []auditing.Entry
		want    *apiv2.AuditServiceGetResponse
		wantErr error
	}{
		{
			name:    "get non existing",
			rq:      &apiv2.AuditServiceGetRequest{Login: "a", Uuid: "99d84f08-85f3-4d4e-881c-29c2c9e1ba58"},
			want:    nil,
		...
		},
		{
			...
			rq: &apiv2.AuditServiceGetRequest{Login: "a-tenant", Uuid: "99d84f08-85f3-4d4e-881c-29c2c9e1ba58"},
			want: &apiv2.AuditServiceGetResponse{
		...
		},
		{
			...
			rq: &apiv2.AuditServiceGetRequest{Login: "a-tenant", Uuid: "99d84f08-85f3-4d4e-881c-29c2c9e1ba58", Phase: new(apiv2.AuditPhase_AUDIT_PHASE_RESPONSE)},
			want: &apiv2.AuditServiceGetResponse{
				Trace: &apiv2.AuditTrace{
					Uuid:      "99d84f08-85f3-4d4e-881c-29c2c9e1ba58",
					Timestamp: timestamppb.New(now),
...
func Test_auditServiceServer_List(t *testing.T) {
	...
	tests := []struct {
		name    string
		rq      *apiv2.AuditServiceListRequest
		entries []auditing.Entry
		want    *apiv2.AuditServiceListResponse
		wantErr error
	}{
		{
			name: "list",
			...
			rq: &apiv2.AuditServiceListRequest{Login: "a-tenant"},
			want: &apiv2.AuditServiceListResponse{
