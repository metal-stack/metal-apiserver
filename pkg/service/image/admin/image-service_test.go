...
func Test_imageServiceServer_Update(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			request: &adminv2.ImageServiceUpdateRequest{Id: "debian-12.0.20241231", Url: &validURL, Name: pointer.Pointer("NewName")},
			want: &adminv2.ImageServiceUpdateResponse{
				Image: &apiv2.Image{
					Id:             "debian-12.0.20241231",
					Url:            validURL,
		...
		},
		{
			...
			request: &adminv2.ImageServiceUpdateRequest{Id: "debian-12.0.20241231", Url: &validURL, Name: pointer.Pointer("NewName"), Features: []apiv2.ImageFeature{apiv2.ImageFeature_IMAGE_FEATURE_FIREWALL}},
			want: &adminv2.ImageServiceUpdateResponse{
				Image: &apiv2.Image{
					Id:             "debian-12.0.20241231",
					Url:            validURL,
		...
		},
		{
			...
			request: &adminv2.ImageServiceUpdateRequest{Id: "debian-12.0.20241231", Url: &validURL, Name: pointer.Pointer("NewName"), Features: []apiv2.ImageFeature{apiv2.ImageFeature_IMAGE_FEATURE_FIREWALL}, Classification: apiv2.ImageClassification_IMAGE_CLASSIFICATION_SUPPORTED},
			want: &adminv2.ImageServiceUpdateResponse{
				Image: &apiv2.Image{
					Id:             "debian-12.0.20241231",
					Url:            validURL,
