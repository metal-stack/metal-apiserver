...
func Test_imageServiceServer_List(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			request: &apiv2.ImageServiceListRequest{Query: &apiv2.ImageQuery{Feature: apiv2.ImageFeature_IMAGE_FEATURE_MACHINE.Enum(), Os: new("debian")}},
			want: &apiv2.ImageServiceListResponse{
				Images: []*apiv2.Image{
					{
						Id:             "debian-12.0.20250101",
		...
		},
		{
			...
			request: &apiv2.ImageServiceListRequest{Query: &apiv2.ImageQuery{Feature: apiv2.ImageFeature_IMAGE_FEATURE_FIREWALL.Enum(), Os: new("debian")}},
			want: &apiv2.ImageServiceListResponse{
				Images: []*apiv2.Image{},
			},
		},
