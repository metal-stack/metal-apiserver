...
type (
	...
	ProvisioningEvent interface {
		Repository[*provisioningEventRepository, *metal.ProvisioningEventContainer, *apiv2.MachineProvisioningEvent, *infrav2.EventServiceSendRequest, *infrav2.EventServiceSendRequest, any]
	}
)
