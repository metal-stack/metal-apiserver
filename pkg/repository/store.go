...
func (s *Store) ProvisioningEvent() ProvisioningEvent {
	...
	return &store[*provisioningEventRepository, *metal.ProvisioningEventContainer, *apiv2.MachineProvisioningEvent, *infrav2.EventServiceSendRequest, *infrav2.EventServiceSendRequest, any]{
		repository: repository,
		typed:      repository,
	}
}
