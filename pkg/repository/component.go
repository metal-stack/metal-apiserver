...
func id(typeString, identifier string) string {
	return newSHA1(nameSpaceOID, []byte(typeString+":"+identifier)).String()
}
...
// UUID will be the lower 4 bits of version.  newHash is used to implement newSHA1.
// Stefan: copied over from google/uuid
