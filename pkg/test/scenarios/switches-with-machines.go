...
var (
	SwitchesWithMachinesDatacenter = DatacenterSpec{
		...
		Switches: []*apiv2.Switch{
			...
			SwitchFunc(P02Rack02Switch1, Partition2, P02Rack02, []string{"Ethernet0"}, SwitchOSSonic2021, Machine4, Machine5),
			SwitchFunc(P02Rack02Switch2, Partition2, P02Rack02, []string{"Ethernet0"}, SwitchOSSonic2021, Machine4, Machine5),
		},
