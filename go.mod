...
replace (
	github.com/metal-stack/tenant-api => ../tenant-api
	github.com/metal-stack/tenant-apiserver => ../tenant-apiserver
)
...
require (
	...
	github.com/metal-stack/tenant-apiserver v0.0.0-00010101000000-000000000000
