...
require (
	...
	github.com/metal-stack/api v0.3.3-0.20260720082330-c0688aa53c87
...
replace (
	github.com/markbates/goth => github.com/metal-stack/goth v0.1.0
	// CI is extremly slow with v0.43.0
	github.com/testcontainers/testcontainers-go => github.com/testcontainers/testcontainers-go v0.42.0
)
...
require (
	...
	github.com/redpanda-data/protoc-gen-go-mcp v0.0.0-20260709214304-372b2d56e470 // indirect
